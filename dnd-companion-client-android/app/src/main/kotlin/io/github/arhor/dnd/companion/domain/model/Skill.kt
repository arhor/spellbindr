...
import io.github.arhor.dnd.companion.domain.serialization.CaseInsensitiveEnumSerializer
 ...
 * @property abilityId The primary ability id that governs this skill.
 */
...
enum class Skill(
    ...
    ACROBATICS(
        ...
        listOf(
            "Your Dexterity (Acrobatics) check covers your attempt to stay on your feet in a tricky situation, such as " +
                "when you're trying to run across a sheet of ice, balance on a tightrope, or stay upright on a rocking " +
    ...
    ANIMAL_HANDLING(
        "Animal Handling",
        listOf(
            "When there is any question whether you can calm down a domesticated animal, keep a mount from getting " +
    ...
    DECEPTION(
        "Deception",
        listOf(
            "Your Charisma (Deception) check determines whether you can convincingly hide the truth, either verbally or " +
                "through your actions. This deception can encompass everything from misleading others through ambiguity " +
                "to telling outright lies. Typical situations include trying to fast- talk a guard, con a merchant, earn " +
    ...
    INSIGHT(
        "Insight",
        listOf(
            "Your Wisdom (Insight) check decides whether you can determine the true intentions of a creature, such as " +
    ...
    INTIMIDATION(
        "Intimidation",
        listOf(
            "When you attempt to influence someone through overt threats, hostile actions, and physical violence, the " +
                "GM might ask you to make a Charisma (Intimidation) check. Examples include trying to pry information out " +
    ...
    INVESTIGATION(
        ...
        listOf(
            "When you look around for clues and make deductions based on those clues, you make an Intelligence " +
                "(Investigation) check. You might deduce the location of a hidden object, discern from the appearance of " +
                "a wound what kind of weapon dealt it, or determine the weakest point in a tunnel that could cause it to " +
    ...
    PERCEPTION(
        "Perception",
        listOf(
            "Your Wisdom (Perception) check lets you spot, hear, or otherwise detect the presence of something. It " +
                "measures your general awareness of your surroundings and the keenness of your senses. For example, you " +
                "might try to hear a conversation through a closed door, eavesdrop under an open window, or hear monsters " +
    ...
    PERSUASION(
        "Persuasion",
        listOf(
            "When you attempt to influence someone or a group of people with tact, social graces, or good nature, the " +
                "GM might ask you to make a Charisma (Persuasion) check. Typically, you use persuasion when acting in good " +
    ...
    SLEIGHT_OF_HAND(
        "Sleight of Hand",
        listOf(
            "Whenever you attempt an act of legerdemain or manual trickery, such as planting something on someone else " +
                "or concealing an object on your person, make a Dexterity (Sleight of Hand) check. The GM might also call " +
    ...
    SURVIVAL(
        "Survival",
        listOf(
            "The GM might ask you to make a Wisdom (Survival) check to follow tracks, hunt wild game, guide your group " +
