...
import io.github.arhor.dnd.companion.domain.model.CasterContribution
...
import io.github.arhor.dnd.companion.domain.model.CharacterSpellPreparation
import io.github.arhor.dnd.companion.domain.model.Choice
import io.github.arhor.dnd.companion.domain.model.Effect
...
import io.github.arhor.dnd.companion.domain.model.LevelUpChoiceOption
import io.github.arhor.dnd.companion.domain.model.LevelUpClassEligibility
import io.github.arhor.dnd.companion.domain.model.LevelUpDeferredFeatDecision
import io.github.arhor.dnd.companion.domain.model.LevelUpFeatEligibility
import io.github.arhor.dnd.companion.domain.model.LevelUpFeatureSpellGrantRequirement
import io.github.arhor.dnd.companion.domain.model.LevelUpHitDicePool
import io.github.arhor.dnd.companion.domain.model.LevelUpPlan
import io.github.arhor.dnd.companion.domain.model.LevelUpPactMagicCapacity
...
import io.github.arhor.dnd.companion.domain.model.LevelUpResource
...
import io.github.arhor.dnd.companion.domain.model.LevelUpSpellReplacementRequirement
...
import io.github.arhor.dnd.companion.domain.model.SpellLearningPolicy
...
object LevelUpProgressionEngine {
    ...
    private fun validateSpellChanges(
        progression: CharacterProgression,
        changes: io.github.arhor.dnd.companion.domain.model.SpellChanges,
        clazz: CharacterClass,
        classLevel: Int,
        subclassId: String?,
        data: LevelUpReferenceData,
        ...
        if (policy == null || policy == SpellLearningPolicy.None) {
            if (changes != io.github.arhor.dnd.companion.domain.model.SpellChanges()) {
                validations += blocking(
        ...
        val allRefs = changes.learned + changes.addedToSpellbook + featureRefs +
            ...
            setOf(io.github.arhor.dnd.companion.domain.model.ClassSpellRef(it.classId, it.removedSpellId),
                io.github.arhor.dnd.companion.domain.model.ClassSpellRef(it.classId, it.learnedSpellId))
        }
        ...
        fun spell(ref: io.github.arhor.dnd.companion.domain.model.ClassSpellRef) = data.spellsById[ref.spellId]
        val ordinaryGrantedRefs = changes.learned + changes.addedToSpellbook + changes.replaced.map { replacement ->
            io.github.arhor.dnd.companion.domain.model.ClassSpellRef(replacement.classId, replacement.learnedSpellId)
        }
        val replacementSourceRefs = changes.replaced.map { replacement ->
            io.github.arhor.dnd.companion.domain.model.ClassSpellRef(replacement.classId, replacement.removedSpellId)
        }
    ...
    private fun maximumSpellLevel(spellcasting: io.github.arhor.dnd.companion.domain.model.LevelSpellcasting?): Int =
    ...
    private fun LevelUpPlan.withMagicInitiateSpellGrant(): LevelUpPlan {
        ...
        val grants = spellIds.mapTo(linkedSetOf()) { spellId ->
            io.github.arhor.dnd.companion.domain.model.ClassSpellRef(classId, spellId)
        }
