...
import io.github.arhor.dnd.companion.domain.model.HitDicePoolState
...
import io.github.arhor.dnd.companion.domain.model.ManagedResource
import io.github.arhor.dnd.companion.domain.model.ManagedSpellGrant
import io.github.arhor.dnd.companion.domain.model.ManagedSpellGrantType
...
import io.github.arhor.dnd.companion.utils.asLoadableFlow
...
class CharacterRepositoryImpl @Inject constructor(
    ...
    private fun CharacterSheet.materializeManagedLevel(
        before: io.github.arhor.dnd.companion.domain.model.LevelUpSnapshot,
        after: io.github.arhor.dnd.companion.domain.model.LevelUpSnapshot,
        updatedProgression: io.github.arhor.dnd.companion.domain.model.CharacterProgression,
        referenceData: LevelUpReferenceData,
    ): CharacterSheet {
        ...
        val slots = (1..9).map { level ->
            ...
            io.github.arhor.dnd.companion.domain.model.SpellSlotState(
                level = level,
                total = total,
        ...
        val pact = after.pactMagic?.let { capacity ->
            io.github.arhor.dnd.companion.domain.model.PactSlotState(
        ...
        val removedManagedSpellStates = mutableMapOf<io.github.arhor.dnd.companion.domain.model.ClassSpellRef, MutableList<io.github.arhor.dnd.companion.domain.model.CharacterSpell>>()
        ...
        updatedSpellGrants.forEach { grant ->
            ...
            val ownership = when (grant.type) {
                ManagedSpellGrantType.Spellbook -> io.github.arhor.dnd.companion.domain.model.CharacterSpellOwnership.Spellbook
                else -> io.github.arhor.dnd.companion.domain.model.CharacterSpellOwnership.Known
            }
            val preparation = existing?.preparation ?: when (grant.type) {
                ManagedSpellGrantType.Spellbook -> io.github.arhor.dnd.companion.domain.model.CharacterSpellPreparation.Unprepared
                ManagedSpellGrantType.Feature -> io.github.arhor.dnd.companion.domain.model.CharacterSpellPreparation.AlwaysPrepared
                else -> io.github.arhor.dnd.companion.domain.model.CharacterSpellPreparation.Prepared
            }
            io.github.arhor.dnd.companion.domain.model.CharacterSpell(
    ...
    private fun io.github.arhor.dnd.companion.domain.model.CharacterProgression.ownedSpellGrants():
            ...
            level.spellChanges.replaced.sortedWith(
                ...
                .forEach { replacement ->
                    ...
                    add(ManagedSpellGrant(
                        ...
                        io.github.arhor.dnd.companion.domain.model.ClassSpellRef(
    ...
    private fun io.github.arhor.dnd.companion.domain.model.CharacterSpell.matches(
        grant: io.github.arhor.dnd.companion.domain.model.ClassSpellRef,
        referenceData: LevelUpReferenceData,
    ): Boolean {
