...
sealed interface CharacterLevelUpUiState {
    ...
    data class Content(
        ...
        val features: List<io.github.arhor.dnd.companion.domain.model.Feature> = emptyList(),
...
private fun io.github.arhor.dnd.companion.domain.model.AbilityScores.scoreFor(abilityId: String): Int =
    when (abilityId) {
