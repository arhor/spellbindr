...
import io.github.arhor.dnd.companion.ui.feature.character.guided.components.ChoiceSection
...
private fun LazyListScope.requirementItem(
    ...
    item(key = requirement.key) {
        ...
        val instruction = (requirement.choice as? io.github.arhor.dnd.companion.domain.model.Choice.OptionsArrayChoice)
            ?.desc
