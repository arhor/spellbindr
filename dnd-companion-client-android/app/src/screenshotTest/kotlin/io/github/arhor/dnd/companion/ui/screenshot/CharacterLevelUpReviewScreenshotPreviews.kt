...
import io.github.arhor.dnd.companion.ui.feature.character.levelup.CharacterLevelUpScreen
import io.github.arhor.dnd.companion.ui.feature.character.levelup.CharacterLevelUpStep
import io.github.arhor.dnd.companion.ui.feature.character.levelup.CharacterLevelUpUiState
...
fun LevelUp_Review_AbilityScoreAndFeat_Screenshot() {
    val feat = io.github.arhor.dnd.companion.domain.model.Feat(
...
private fun ReviewScreenshot(
    ...
    feats: List<io.github.arhor.dnd.companion.domain.model.Feat> = emptyList(),
...
private fun simpleClass(id: String, name: String, spellcasting: Boolean = false) = CharacterClass(id, name, hitDie = 10, proficiencies = emptyList(), proficiencyChoices = emptyList(), savingThrows = emptyList(), spellcasting = if (spellcasting) io.github.arhor.dnd.companion.domain.model.Spellcasting(emptyList(), 1, EntityRef(AbilityIds.INT)) else null, subclasses = emptyList(), levels = emptyList())
