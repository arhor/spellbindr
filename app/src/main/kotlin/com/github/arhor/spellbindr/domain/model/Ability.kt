...
enum class Ability(
    ...
    STR(
        ...
        description = listOf(
            ...
            "A Strength check can model any attempt to lift, push, pull, or break something, to force your body through " +
                "a space, or to otherwise apply brute force to a situation. The Athletics skill reflects aptitude in " +
    ...
    DEX(
        ...
        description = listOf(
            ...
            "A Dexterity check can model any attempt to move nimbly, quickly, or quietly, or to keep from falling on " +
                "tricky footing. The Acrobatics, Sleight of Hand, and Stealth skills reflect aptitude in certain kinds " +
                "of Dexterity checks.",
        ),
    ),
    CON(
        ...
        description = listOf(
            ...
            "Constitution checks are uncommon, and no skills apply to Constitution checks, because the endurance this " +
                "ability represents is largely passive rather than involving a specific effort on the part of a character " +
                "or monster.",
        ),
    ),
    INT(
        ...
        description = listOf(
            ...
            "An Intelligence check comes into play when you need to draw on logic, education, memory, or deductive " +
                "reasoning. The Arcana, History, Investigation, Nature, and Religion skills reflect aptitude in certain " +
    ...
    WIS(
        ...
        description = listOf(
            ...
            "A Wisdom check might reflect an effort to read body language, understand someone's feelings, notice things " +
                "about the environment, or care for an injured person. The Animal Handling, Insight, Medicine, Perception, " +
    ...
    CHA(
        ...
        description = listOf(
            "Charisma measures your ability to interact effectively with others. It includes such factors as confidence " +
                "and eloquence, and it can represent a charming or commanding personality.",
            "A Charisma check might arise when you try to influence or entertain others, when you try to make an " +
                "impression or tell a convincing lie, or when you are navigating a tricky social situation. The Deception, " +
                "Intimidation, Performance, and Persuasion skills reflect aptitude in certain kinds of Charisma checks.",
        ),
    ),
    ;
