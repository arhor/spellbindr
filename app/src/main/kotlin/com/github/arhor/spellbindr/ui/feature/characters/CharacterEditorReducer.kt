...
sealed interface CharacterEditorAction {
    ...
    data class AbilityChanged(val abilityId: String, val value: String) : CharacterEditorAction
    ...
    data class SavingThrowProficiencyChanged(val abilityId: String, val value: Boolean) : CharacterEditorAction
