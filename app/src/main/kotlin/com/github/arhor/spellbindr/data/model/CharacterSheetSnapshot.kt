...
private fun defaultSavingThrows(): List<SavingThrowEntry> =
    com.github.arhor.spellbindr.domain.model.defaultSavingThrows()

private fun defaultSkills(): List<SkillEntry> =
    com.github.arhor.spellbindr.domain.model.defaultSkills()

private fun defaultSpellSlots(): List<SpellSlotState> =
    com.github.arhor.spellbindr.domain.model.defaultSpellSlots()
